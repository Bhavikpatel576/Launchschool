#create a program that counts the number of occurances of words
#in a sentence 

#split the string into an arary
#create a hashmap
#iterate through the string array
#test to see if word is in hashmap
##add word to hsh if not
##increase value
...
class Phrase
	...
	def initialize(word)
		@word = word.downcase.scan(/\b[a-zA-Z0-9']+\b/)
	end
